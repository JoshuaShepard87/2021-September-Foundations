...
$(document).ready(function() {
    ...
    $('button').on('click', function() {
        ...
        animation is complete, remove the shake and animated classes so that the 
        ...
        */
        ...
        // Check email input
        if ($('#email').val() === '') {
            $('#email').addClass('form-error animate__animated animate__shakeX')
        ...
        if ($('#message').val() === '') {
            $('#message').addClass('form-error animate__animated animate__shakeX')
                        .one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
                            $(this).removeClass('animate__animated animate__shakeX');
                        });
        } else {
